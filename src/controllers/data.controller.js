...
const createData = async (req, res) => {
    let { flow, volume, continuityL, continuityH } = req.body;
    let idBoard = req.headers.idboard;
    let idUser = await boardUtils.getBoardUser(idBoard);
    if (typeof idUser === "undefined" || typeof flow === "undefined" || typeof volume === "undefined" || typeof continuityL === "undefined" || typeof continuityH === "undefined") return res.status(400).send({ error: true, message: 'Missing required fields!' });
